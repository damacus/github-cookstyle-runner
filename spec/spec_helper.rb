...
# This will load config and set up ConfigGem constant via config/initializers/config.rb
require_relative '../lib/cookstyle_runner'

# Load VCR for HTTP interaction recording/replay
require_relative 'support/vcr'

# Load SemanticLogger for testing

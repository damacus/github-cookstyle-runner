...
class RuboCop::Config
  # source://rubocop/1.81.0/lib/rubocop/config.rb#31
  ...
  # source://rubocop/1.81.0/lib/rubocop/config.rb#212
  def active_support_extensions_enabled?; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#127
  def add_excludes_from_higher_level(highest_config); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#239
  def allowed_camel_case_file?(file); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#283
  def base_dir_for_path_parameters; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#313
  def bundler_lock_file_path; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#85
  def check; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#180
  def clusivity_config_for_badge?(badge); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#200
  def cop_enabled?(name); end

  # source://rubocop-ast/1.47.1/lib/rubocop/ast/utilities/simple_forwardable.rb#19
  def delete(*_arg0, **_arg1, &_arg2); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#139
  def deprecation_check; end

  # source://rubocop-ast/1.47.1/lib/rubocop/ast/utilities/simple_forwardable.rb#19
  def dig(*_arg0, **_arg1, &_arg2); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#204
  ...
  # source://rubocop/1.81.0/lib/rubocop/config.rb#208
  def enabled_new_cops?; end

  # source://rubocop-ast/1.47.1/lib/rubocop/ast/utilities/simple_forwardable.rb#19
  def fetch(*_arg0, **_arg1, &_arg2); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#261
  def file_to_exclude?(file); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#220
  def file_to_include?(file); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#196
  def for_all_cops; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#166
  def for_badge(badge); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#153
  def for_cop(cop); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#191
  def for_department(department_name); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#160
  def for_enabled_cop(cop); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#338
  def gem_versions_in_target; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#342
  def inspect; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#110
  def internal?; end
  ...
  # source://rubocop/1.81.0/lib/rubocop/config.rb#81
  def loaded_features; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#21
  def loaded_path; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#77
  def loaded_plugins; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#115
  ...
  # source://rubocop/1.81.0/lib/rubocop/config.rb#293
  def parser_engine; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#274
  def path_relative_to_config(path); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#270
  def patterns_to_exclude; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#266
  def patterns_to_include; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#324
  def pending_cops; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#253
  def possibly_include_hidden?; end

  # source://rubocop-ast/1.47.1/lib/rubocop/ast/utilities/simple_forwardable.rb#19
  def replace(*_arg0, **_arg1, &_arg2); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#105
  def signature; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#308
  def smart_loaded_path; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#216
  ...
  # source://rubocop/1.81.0/lib/rubocop/config.rb#297
  ...
  # source://rubocop/1.81.0/lib/rubocop/config.rb#101
  def to_s; end
  ...
  # source://rubocop/1.81.0/lib/rubocop/config.rb#92
  def validate_after_resolution; end

  private

  # source://rubocop/1.81.0/lib/rubocop/config.rb#392
  def department_of(qualified_cop_name); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#380
  def enable_cop?(qualified_cop_name, cop_options); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#367
  def gem_version_to_major_minor_float(gem_version); end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#373
  def read_gem_versions_from_target_lockfile; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#354
  def read_rails_version_from_bundler_lock_file; end

  # source://rubocop/1.81.0/lib/rubocop/config.rb#349
  def target_rails_version_from_bundler_lock_file; end

  class << self
    # source://rubocop/1.81.0/lib/rubocop/config.rb#23
...
class RuboCop::Cop::Base
  ...
  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#156
  def initialize(config = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#278
  def active_support_extensions_enabled?; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#189
  def add_global_offense(message = T.unsafe(nil), severity: T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#201
  def add_offense(node_or_range, message: T.unsafe(nil), severity: T.unsafe(nil), &block); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#357
  def always_autocorrect?; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#343
  def begin_investigation(processed_source, offset: T.unsafe(nil), original: T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#324
  def callbacks_needed; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#43
  def config; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#252
  def config_to_allow_offenses; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#256
  def config_to_allow_offenses=(hash); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#363
  def contextual_autocorrect?; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#246
  def cop_config; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#238
  def cop_name; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#295
  def excluded_file?(file); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#234
  def external_dependency_checksum; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#367
  def inspect; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#183
  def message(_range = T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#238
  def name; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#315
  def offenses; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#170
  def on_investigation_end; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#164
  def on_new_investigation; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#176
  def on_other_file; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#300
  def parse(source, path = T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#270
  def parser_engine; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#43
  def processed_source; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#306
  def ready; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#286
  def relevant_file?(file); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#282
  def string_literals_frozen_by_default?; end
  ...
  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#266
  def target_gem_version(gem_name); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#274
  def target_rails_version; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#260
  def target_ruby_version; end

  private

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#485
  def annotate(message); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#379
  def apply_correction(corrector); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#449
  def attempt_correction(range, corrector); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#375
  def callback_argument(range); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#408
  def complete_investigation; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#423
  def correct(range); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#393
  def current_corrector; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#385
  def current_offense_locations; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#397
  def current_offenses; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#389
  def currently_disabled_lines; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#513
  def custom_severity; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#509
  def default_severity; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#463
  def disable_uncorrectable(range); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#499
  def enabled_line?(line_number); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#491
  def file_name_matches_any?(file, parameter, default_result); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#481
  def find_message(range, message); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#505
  def find_severity(_range, severity); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#526
  def range_for_original(range); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#470
  def range_from_node_or_range(node_or_range); end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#418
  def reset_investigation; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#534
  def target_satisfies_all_gem_version_requirements?; end

  # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#438
  def use_corrector(range, corrector); end

  class << self
    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#59
    def autocorrect_incompatible_with; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#93
    def badge; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#329
    def callbacks_needed; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#97
    def cop_name; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#101
    def department; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#70
    def documentation_url(config = T.unsafe(nil)); end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#81
    def exclude_from_registry; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#138
    def gem_requirements; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#74
    def inherited(subclass); end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#118
    def joining_forces; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#105
    def lint?; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#111
    def match?(given_names); end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#151
    def requires_gem(gem_name, *version_requirements); end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#87
    def support_autocorrect?; end

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#129
    def support_multiple_source?; end

    private

    # source://rubocop/1.81.0/lib/rubocop/cop/base.rb#401
...
#   end
#
# source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#73
class RuboCop::Cop::Chef::Correctness::EmptyResourceGuard < ::RuboCop::Cop::Base
  # @return [Boolean]
  #
  # source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#85
  def empty_string?(str); end

  # source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#81
  def empty_string_block_guard?(param0 = T.unsafe(nil)); end

  # source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#77
  def empty_string_guard?(param0 = T.unsafe(nil)); end

  # source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#95
  def on_block(node); end

  # source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#89
  def on_send(node); end
end

# source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#74
RuboCop::Cop::Chef::Correctness::EmptyResourceGuard::MSG = T.let(T.unsafe(nil), String)

# source://cookstyle//lib/rubocop/cop/chef/correctness/empty_resource_guard.rb#75
RuboCop::Cop::Chef::Correctness::EmptyResourceGuard::RESTRICT_ON_SEND = T.let(T.unsafe(nil), Array)
...
class RuboCop::Cop::Chef::Deprecations::HWRPWithoutProvides < ::RuboCop::Cop::Base
  ...
  # source://cookstyle//lib/rubocop/cop/chef/deprecation/hwrp_without_provides.rb#129
...
class RuboCop::Cop::Registry
  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#51
  def initialize(cops = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#232
  def ==(other); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#97
  def contains_cop_matching?(names); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#179
  def cops; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#224
  def cops_for_department(department); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#93
  def department?(name); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#147
  def department_missing?(badge, name); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#72
  def departments; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#193
  def disabled(config); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#67
  def dismiss(cop); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#247
  def each(&block); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#189
  def enabled(config); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#197
  def enabled?(cop, config); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#213
  def enabled_pending_cop?(cop_cfg, config); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#63
  def enlist(cop); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#253
  def find_by_cop_name(cop_name); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#260
  def find_cops_by_directive(directive); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#265
  def freeze; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#184
  def length; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#220
  def names; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#228
  def names_for_department(department); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#49
  def options; end
  ...
  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#133
  def qualified_cop_name(name, path, warn: T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#166
  def qualify_badge(badge); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#243
  def select(&block); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#236
  def sort!; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#174
  def to_h; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#159
  def unqualified_cop_names; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#78
  def with_department(department); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#84
  def without_department(department); end

  private

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#283
  def clear_enrollment_queue; end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#279
  def initialize_copy(reg); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#312
  def registered?(badge); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#299
  def resolve_badge(given_badge, real_badge, source_path, warn: T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#295
  def with(cops); end

  class << self
    # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#22
    def all; end

    # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#274
    def global; end

    # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#44
    def qualified_cop?(name); end

    # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#26
    def qualified_cop_name(name, origin, warn: T.unsafe(nil)); end

    # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#40
    def reset!; end

    # source://rubocop/1.81.0/lib/rubocop/cop/registry.rb#32
...
class RuboCop::Cop::Team
  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#61
  def initialize(cops, config = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#72
  def autocorrect?; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#57
  def cops; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#76
  def debug?; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#57
  def errors; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#128
  def external_dependency_checksum; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#120
  def forces; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#82
  def inspect_file(processed_source); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#91
  ...
  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#139
  def autocorrect(processed_source, report, original:, offset:); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#203
  def autocorrect_report(report, offset:, original:); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#158
  def be_ready; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#209
  def collate_corrections(report, offset:, original:); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#225
  def each_corrector(report); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#277
  def handle_error(error, location, cop); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#269
  def handle_warning(error, location); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#172
  def investigate_partial(cops, processed_source, offset:, original:); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#252
  def process_errors(file, errors); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#166
  def reset; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#194
  def support_target_rails_version?(cop); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#188
  def support_target_ruby_version?(cop); end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#240
  def suppress_clobbering; end

  # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#246
  def validate_config; end

  class << self
    # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#43
    def forces_for(cops); end

    # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#28
    def mobilize(cop_classes, config, options = T.unsafe(nil)); end

    # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#34
    def mobilize_cops(cop_classes, config, options = T.unsafe(nil)); end

    # source://rubocop/1.81.0/lib/rubocop/cop/team.rb#15
...
class RuboCop::DirectiveComment
  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#46
  def initialize(comment, cop_registry = T.unsafe(nil)); end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#115
  def all_cops?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#44
  def comment; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#120
  def cop_names; end
  ...
  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#131
  def department_names; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#145
  def directive_count; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#95
  def disabled?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#110
  def disabled_all?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#100
  def enabled?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#105
  def enabled_all?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#136
  def in_directive_department?(cop); end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#150
  def line_number; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#59
  def malformed?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#77
  def match?(cop_names); end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#90
  def match_captures; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#67
  def missing_cop_name?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#44
  def mode; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#141
  def overridden_by_department?(cop); end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#81
  def range; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#125
  def raw_cop_names; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#72
  def single_line?; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#54
  def start_with_marker?; end

  private

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#167
  def all_cop_names; end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#171
  def cop_names_for_department(department); end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#163
  def department?(name); end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#176
  def exclude_lint_department_cops(cops); end

  # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#156
  def parsed_cop_names; end

  class << self
    # source://rubocop/1.81.0/lib/rubocop/directive_comment.rb#40

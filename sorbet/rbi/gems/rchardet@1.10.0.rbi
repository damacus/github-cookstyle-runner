...
module CharDet
  class << self
    # source://rchardet//lib/rchardet.rb#59
    def detect(aBuf); end
  end
end
...
# source://rchardet//lib/rchardet/utf1632prober.rb#31
CharDet::EXPECTED_RATIO = T.let(T.unsafe(nil), Float)
...
# source://rchardet//lib/rchardet/utf1632prober.rb#30
CharDet::MIN_CHARS_FOR_DETECTION = T.let(T.unsafe(nil), Integer)
...
# source://rchardet//lib/rchardet/utf1632prober.rb#33
class CharDet::UTF1632Prober < ::CharDet::CharSetProber
  # @return [UTF1632Prober] a new instance of UTF1632Prober
  #
  # source://rchardet//lib/rchardet/utf1632prober.rb#34
  def initialize; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#82
  def feed(aBuf); end

  # source://rchardet//lib/rchardet/utf1632prober.rb#65
  def get_charset_name; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#117
  def get_confidence; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#102
  def get_state; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#50
  def reset; end

  private

  # source://rchardet//lib/rchardet/utf1632prober.rb#131
  def approx_16bit_chars; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#127
  def approx_32bit_chars; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#156
  def is_likely_utf16be; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#164
  def is_likely_utf16le; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#135
  def is_likely_utf32be; end

  # source://rchardet//lib/rchardet/utf1632prober.rb#146
  def is_likely_utf32le; end

  # @param pair [Array<Integer>] two consecutive bytes
  # @return [void]
  #
  # source://rchardet//lib/rchardet/utf1632prober.rb#193
  def validate_utf16_characters(pair); end

  # @param quad [Array<Integer>] four consecutive bytes
  # @return [void]
  #
  # source://rchardet//lib/rchardet/utf1632prober.rb#174
  def validate_utf32_characters(quad); end
end
...
class CharDet::UniversalDetector
  ...
  # source://rchardet//lib/rchardet/universaldetector.rb#166
  def close; end
  ...
  # source://rchardet//lib/rchardet/universaldetector.rb#68
  def feed(aBuf); end

  # source://rchardet//lib/rchardet/universaldetector.rb#50
  def reset; end

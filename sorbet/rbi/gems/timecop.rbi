...
class Timecop
  ...
  def self.mock_process_clock=(mock); end
  def self.mock_process_clock?; end
  def self.new(*, **); end
...
class Time
  ...
  def self.new_without_mock_time(*, **); end
  def self.now_with_mock_time; end
  def self.now_without_mock_time(in: nil); end
end
class Date
...
module Process
  def self.clock_gettime_mock_time(clock_id, unit = nil); end
  def self.clock_gettime_without_mock(*arg0); end
  def self.mock_time_monotonic; end
  def self.mock_time_realtime; end
end

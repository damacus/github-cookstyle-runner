...
module SemanticLogger::Appender
  class << self
    ...
    #
    # source://semantic_logger//lib/semantic_logger/appender.rb#34
    ...
    #
    # source://semantic_logger//lib/semantic_logger/appender.rb#65
...
class SemanticLogger::Appender::Async
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#80
  def active?; end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#66
  def capped?; end

  # Close all appenders and flush any outstanding messages.
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#96
  def close; end
  ...
  #  All queued log messages are written and then each appender is flushed in turn.
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#91
  def flush; end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#85
  def log(log); end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#53
  def reopen; end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#73
  def thread; end

  private

  # source://semantic_logger//lib/semantic_logger/appender/async.rb#181
  def check_lag(log); end

  # source://semantic_logger//lib/semantic_logger/appender/async.rb#103
  def create_queue; end

  # Separate thread for batching up log messages before writing.
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#114
  def process; end

  # Returns false when message processing should be stopped
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#166
  def process_message(message); end

  # source://semantic_logger//lib/semantic_logger/appender/async.rb#147
  def process_messages; end

  # Submit command and wait for reply
  #
  # source://semantic_logger//lib/semantic_logger/appender/async.rb#189
...
class SemanticLogger::Appender::AsyncBatch < ::SemanticLogger::Appender::Async
  ...
  # Add log message for processing.
  #
  # source://semantic_logger//lib/semantic_logger/appender/async_batch.rb#48
  def log(log); end
  ...
  # Separate thread for batching up log messages before writing.
  #
  # source://semantic_logger//lib/semantic_logger/appender/async_batch.rb#58
  def process_messages; end

  # source://semantic_logger//lib/semantic_logger/appender/async_batch.rb#86
  def submit_request(command); end
end
...
class SemanticLogger::Appender::ElasticsearchHttp < ::SemanticLogger::Appender::Http
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/elasticsearch_http.rb#73
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/elasticsearch_http.rb#68
  def log(log); end
...
class SemanticLogger::Appender::File < ::SemanticLogger::Subscriber
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#206
  def flush; end

  # Since only one appender thread will be writing to the file at a time
  # it is not necessary to protect access to the file with a semaphore.
  #
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#184
  def log(log); end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#149
  def reopen; end
  ...
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#222
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#281
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#212
  def current_file_name=(_arg0); end

  # source://semantic_logger//lib/semantic_logger/appender/file.rb#228
  ...
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#255
  def next_reopen_period(period_string); end

  # @raise [ArgumentError]
  #
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#262
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/appender/file.rb#214
...
class SemanticLogger::Appender::Http < ::SemanticLogger::Subscriber
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#188
  def log(log); end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#159
  def reopen; end
  ...
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#201
  def compress_data(data); end

  # Use JSON Formatter by default
  #
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#197
  def default_formatter; end

  # HTTP Delete
  #
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#222
  def delete(request_uri = T.unsafe(nil)); end

  # HTTP Post
  #
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#210
  def post(body, request_uri = T.unsafe(nil)); end

  # Process HTTP Request
  #
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#228
  def process_request(request, body = T.unsafe(nil)); end

  # HTTP Put
  #
  # source://semantic_logger//lib/semantic_logger/appender/http.rb#216
...
# source://semantic_logger//lib/semantic_logger/appender/loki.rb#13
class SemanticLogger::Appender::Loki < ::SemanticLogger::Appender::Http
  ...
  #     Default: nil
  #
  # @return [Loki] a new instance of Loki
  #
  # source://semantic_logger//lib/semantic_logger/appender/loki.rb#37
  def initialize(url: T.unsafe(nil), formatter: T.unsafe(nil), header: T.unsafe(nil), path: T.unsafe(nil), **args, &block); end

  # Logs in batches
  #
  # source://semantic_logger//lib/semantic_logger/appender/loki.rb#55
  def batch(logs); end

  # source://semantic_logger//lib/semantic_logger/appender/loki.rb#47
  def log(log); end
end

# source://semantic_logger//lib/semantic_logger/appender/loki.rb#14
...
class SemanticLogger::Appender::SplunkHttp < ::SemanticLogger::Appender::Http
  ...
  #
  # source://semantic_logger//lib/semantic_logger/appender/splunk_http.rb#90
...
class SemanticLogger::Base
  ...
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#278
  ...
  # source://semantic_logger//lib/semantic_logger/base.rb#239
  ...
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#244
  def log(_log_); end
  ...
  # source://semantic_logger//lib/semantic_logger/base.rb#212
  def named_tags; end

  # source://semantic_logger//lib/semantic_logger/base.rb#229
  def pop_tags(quantity = T.unsafe(nil)); end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#222
  def push_tags(*tags); end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#249
  def should_log?(log); end

  # source://semantic_logger//lib/semantic_logger/base.rb#234
  ...
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#188
  def tagged(*tags); end

  # source://semantic_logger//lib/semantic_logger/base.rb#208
  def tags; end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#303
  ...
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#298
  def level_index; end

  # Log message at the specified level
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#315
  ...
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#412
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/base.rb#310
...
module SemanticLogger::Formatters
  class << self
    ...
    #
    # source://semantic_logger//lib/semantic_logger/formatters.rb#26
...
class SemanticLogger::Formatters::Base
  ...
  # @return [Base] a new instance of Base
  #
  # source://semantic_logger//lib/semantic_logger/formatters/base.rb#37
  ...
  # Process ID
  #
  # source://semantic_logger//lib/semantic_logger/formatters/base.rb#65
  def pid; end
  ...
  # Date & time
  #
  # source://semantic_logger//lib/semantic_logger/formatters/base.rb#60
  def time; end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/base.rb#72
  ...
  class << self
    ...
    #     Default: PRECISION (6, except on older JRuby, where 3)
    #
    # source://semantic_logger//lib/semantic_logger/formatters/base.rb#55
...
# source://semantic_logger//lib/semantic_logger/formatters/loki.rb#5
class SemanticLogger::Formatters::Loki < ::SemanticLogger::Formatters::Base
  # Returns [String] a JSON batch of logs
  #
  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#17
  def batch(logs, logger); end

  # Returns [String] a single JSON log
  #
  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#9
  def call(log, logger); end

  # Returns the value of attribute payload_value.
  #
  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#6
  def payload_value; end

  # Sets the attribute payload_value
  #
  # @param value the value to set the attribute payload_value to.
  #
  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#6
  ...
  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#56
  def application; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#30
  def build_stream; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#80
  def context; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#122
  def duration; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#60
  def environment; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#129
  def exception; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#102
  def format_time(log); end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#52
  def host; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#64
  def level; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#98
  def message; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#115
  def metric; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#76
  def named_tags; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#106
  def payload; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#139
  def stringify_hash(hash); end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#72
  def tags; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#68
  def thread; end

  # source://semantic_logger//lib/semantic_logger/formatters/loki.rb#94
  def time; end
end
...
# source://semantic_logger//lib/semantic_logger/formatters/open_telemetry.rb#4
class SemanticLogger::Formatters::OpenTelemetry < ::SemanticLogger::Formatters::Raw
  # Log level
  #
  # source://semantic_logger//lib/semantic_logger/formatters/open_telemetry.rb#6
  def level; end

  # Payload is submitted directly as attributes
  #
  # source://semantic_logger//lib/semantic_logger/formatters/open_telemetry.rb#12
  def payload; end

  private

  # source://semantic_logger//lib/semantic_logger/formatters/open_telemetry.rb#20
...
class SemanticLogger::Formatters::Signalfx < ::SemanticLogger::Formatters::Base
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#110
  def batch(logs, logger); end

  # Returns [Hash] log message in Signalfx format.
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#79
  def call(log, logger); end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#57
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#24
  def metric; end

  # Date & time
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#46
  def time; end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#52
  def value; end
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#151
  ...
  #
  # source://semantic_logger//lib/semantic_logger/formatters/signalfx.rb#157
...
class SemanticLogger::Log
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#128
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#190
  def backtrace_to_s; end

  # Strip the standard Rails colorizing from the logged message
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#268
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#218
  def duration_human; end

  # source://semantic_logger//lib/semantic_logger/log.rb#210
  def duration_to_s; end

  # Call the block for exception and any nested exception
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#168
  ...
  # @raise [ArgumentError]
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#142
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#251
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#262
  ...
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#236
  def level_to_s; end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#279
  def payload?; end
  ...
  # DEPRECATED
  #
  # source://semantic_logger//lib/semantic_logger/log.rb#241
  ...
  # source://semantic_logger//lib/semantic_logger/log.rb#283
  def to_h(host = T.unsafe(nil), application = T.unsafe(nil), environment = T.unsafe(nil)); end
end

# source://semantic_logger//lib/semantic_logger/log.rb#248
SemanticLogger::Log::CALLER_REGEXP = T.let(T.unsafe(nil), Regexp)

# source://semantic_logger//lib/semantic_logger/log.rb#166
...
module SemanticLogger::Loggable::ClassMethods
  ...
  #
  # source://semantic_logger//lib/semantic_logger/loggable.rb#120
...
class SemanticLogger::Metric::Signalfx < ::SemanticLogger::Appender::Http
  ...
  # Logs in batches
  #
  # source://semantic_logger//lib/semantic_logger/metric/signalfx.rb#97
  def batch(logs); end
  ...
  # source://semantic_logger//lib/semantic_logger/metric/signalfx.rb#90
  def log(log); end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/metric/signalfx.rb#104
  def should_log?(log); end
end
...
class SemanticLogger::Subscriber < ::SemanticLogger::Base
  ...
  # set for this instance.
  #
  # source://semantic_logger//lib/semantic_logger/subscriber.rb#127
  def level_index; end
  ...
  # @return [Boolean]
  #
  # source://semantic_logger//lib/semantic_logger/subscriber.rb#132
  def metrics?; end
end
...
module SemanticLogger::Utils
  class << self
    ...
    #
    # source://semantic_logger//lib/semantic_logger/utils.rb#16
    ...
    #
    # source://semantic_logger//lib/semantic_logger/utils.rb#38
    ...
    # @return [Boolean]
    #
    # source://semantic_logger//lib/semantic_logger/utils.rb#50
    def extract_path?(path); end

    # source://semantic_logger//lib/semantic_logger/utils.rb#45
    def extract_paths; end

    # Returns the visibility for an instance method
    #
    # source://semantic_logger//lib/semantic_logger/utils.rb#25
    ...
    #
    # source://semantic_logger//lib/semantic_logger/utils.rb#57
    ...
    # @return [Boolean]
    #
    # source://semantic_logger//lib/semantic_logger/utils.rb#76
    def strip_path?(path); end

    # Paths to exclude in the stripped backtrace
    # Includes Gems and built-in Ruby code paths
    #
    # source://semantic_logger//lib/semantic_logger/utils.rb#66
    def strip_paths; end
  end
end

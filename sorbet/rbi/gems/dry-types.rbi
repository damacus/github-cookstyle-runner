...
class Dry::Types::Container
  def config; end
  extend Anonymous_Dry_Configurable_Extension_21
  extend Dry::Configurable
  extend Dry::Configurable::ClassMethods
  extend Dry::Core::Container::Configuration
  include Dry::Core::Container::Mixin
end
module Anonymous_Dry_Configurable_Extension_21
end
...
module Anonymous_Dry_Logic_Rule_Interface_27
  def [](input0); end
  def call(input0); end
  def initialize(*); end
end
class Dry::Logic::Rule::Predicate::Predicate2Arity1Curried < Dry::Logic::Rule::Predicate
  include Anonymous_Dry_Logic_Rule_Interface_27
end

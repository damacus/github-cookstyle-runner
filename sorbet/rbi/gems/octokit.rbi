...
module Octokit::Warnable
  ...
  def self.octokit_warn(*message); end
end
...
module Octokit::Connection
  ...
  def paginate(url, options = nil); end
...
class Octokit::Client
  ...
  def as_app(key = nil, secret = nil); end
...
module Octokit::Client::ActionsArtifacts
  def artifact(repo, id, options = nil); end
  def artifact_download_url(repo, id, options = nil); end
  def delete_artifact(repo, id, options = nil); end
  def repository_artifacts(repo, options = nil); end
...
module Octokit::Client::ActionsWorkflows
  ...
  def workflow_disable(repo, id, options = nil); end
  def workflow_dispatch(repo, id, ref, options = nil); end
  def workflow_enable(repo, id, options = nil); end
  def workflows(repo, options = nil); end
end
module Octokit::Client::ActionsWorkflowJobs
  def list_workflow_run_attempt_jobs(repo, run_id, attempt_number, options = nil); end
  def list_workflow_run_jobs(repo, run_id, options = nil); end
  def workflow_run_attempt_jobs(repo, run_id, attempt_number, options = nil); end
  def workflow_run_job(repo, job_id, options = nil); end
  def workflow_run_job_logs(repo, job_id, options = nil); end
  def workflow_run_jobs(repo, run_id, options = nil); end
end
module Octokit::Client::ActionsWorkflowRuns
  ...
  def workflow_run_usage(repo, id, options = nil); end
...
module Octokit::Client::Environments
  def create_or_update_environment(repo, environment_name, options = nil); end
  def delete_environment(repo, environment_name, options = nil); end
  def environment(repo, environment_name, options = nil); end
  def environments(repo, options = nil); end
  def list_environments(repo, options = nil); end
end
...
module Octokit::Client::Labels
  ...
  def replace_all_labels(repo, number, labels, _options = nil); end
...
module Octokit::Client::Organizations
  ...
  def organization_audit_log(org, options = nil); end
  ...
  def remove_team_repo(team_id, repo, _options = nil); end
  def remove_team_repository(team_id, repo, _options = nil); end
  ...
  def team_permissions_for_repo(org, team_slug_or_id, owner, repo, options = nil); end
  def team_repo?(team_id, repo, _options = nil); end
  def team_repos(team_id, options = nil); end
  def team_repositories(team_id, options = nil); end
  def team_repository?(team_id, repo, _options = nil); end
...
module Octokit::Client::PullRequests
  ...
  def update_pull_request_branch(repo, number, options = nil); end
...
module Octokit::Client::RateLimit
  def rate_limit!(_options = nil); end
  def rate_limit(_options = nil); end
  def rate_limit_remaining!(_options = nil); end
  def rate_limit_remaining(_options = nil); end
  def ratelimit!(_options = nil); end
  def ratelimit(_options = nil); end
  def ratelimit_remaining!(_options = nil); end
  def ratelimit_remaining(_options = nil); end
end
...
module Octokit::Client::Search
  ...
  def search_topics(query, options = nil); end
...
module Octokit::Client::Users
  def add_email(email, _options = nil); end

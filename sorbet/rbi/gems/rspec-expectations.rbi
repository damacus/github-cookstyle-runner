...
class InvalidName___Class_0x00___Differ_80
end
...
class RSpec::Matchers::BuiltIn::Exist::ExistenceTest < Anonymous_Struct_81
...
class RSpec::Matchers::BuiltIn::CaptureStreamToTempfile < Anonymous_Struct_82

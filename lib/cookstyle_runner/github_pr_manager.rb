...
module CookstyleRunner
  ...
  class GitHubPRManager
    ...
    T::Sig::WithoutRuntime.sig { returns(T.any(Octokit::Client, Object)) }
    ...
    sig { params(settings: ::Config::Options, logger: Logger, github_client: T.any(Octokit::Client, Object)).void }
    def initialize(settings, logger, github_client)
      @settings = T.let(settings, ::Config::Options)
      @logger = T.let(logger, Logger)
      @github_client = T.let(github_client, T.any(Octokit::Client, Object))
